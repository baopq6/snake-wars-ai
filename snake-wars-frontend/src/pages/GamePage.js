...
const GamePage = () => {
  ...
  const [health, setHealth] = useState(100); // Khởi tạo health
  ...
  return (
    <div className="game-page">
      ...
      <GameCanvas setScore={setScore} setPosition={setPosition} setEnemies={setEnemies} setHealth={setHealth} /> {/* Truyền setHealth */}
